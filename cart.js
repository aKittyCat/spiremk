        ...
        <tr class="border-t border-gray-700/40">
          ...
          <td class="px-4 py-3 text-gray-300">
            ${e.options
              .map(
                (o) =>
                  `<span class="inline-block bg-gray-700/60 px-2 py-0.5 rounded mr-1 mb-1">${escapeHtml(
                    o
                  )}</span>`
              )
              .join("")}
          ...
          <td class="px-2 py-3 text-center">
            <div class="inline-flex items-center bg-gray-700/60 rounded">
              <button class="px-2" data-dec="${
                e.key
              }" aria-label="decrease">−</button>
              <input class="w-14 text-center bg-transparent outline-none" data-qty="${
                e.key
              }" value="${e.qty}">
              <button class="px-2" data-inc="${
                e.key
          ...
          <td class="px-2 py-3 text-center">
            <button class="text-red-400 hover:text-red-300" title="ลบ" data-remove="${
              e.key
            }">✕</button>
          </td>
        </tr>
