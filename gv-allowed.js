...
(function(){
  ...
  const GV_ALLOWED = {
    ...
    "shield+1":           { kind: "shield",   list: makeSet(["Shield"]),            makeName: (base)=> `${base} +1 ` },
    "shield+2":           { kind: "shield",   list: makeSet(["Shield"]),            makeName: (base)=> `${base} +2 ` },
    "shield+3":           { kind: "shield",   list: makeSet(["Shield"]),            makeName: (base)=> `${base} +3 ` },
