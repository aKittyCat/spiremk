...
(function () {
  ...
  const GV_ALLOWED = {
    ...
    "bow-of-conflagration": { kind: "weapon", list: makeSet(GLIMMERING_MOONBOW_BASES), makeName: (base) => `${base} of Conflagration` },
    "bow-of-melodies": { kind: "weapon", list: makeSet(GLIMMERING_MOONBOW_BASES), makeName: (base) => `${base} of Melodies` },
    ...
    "dragon-wing-bow": { kind: "weapon", list: makeSet(GLIMMERING_MOONBOW_BASES), makeName: (base) => `Dragon Wing ${base}` },
    ...
    "red-feather-bow": { kind: "weapon", list: makeSet(GLIMMERING_MOONBOW_BASES), makeName: (base) => `Red-Feather ${base}` },
